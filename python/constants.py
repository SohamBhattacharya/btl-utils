...
class SM:
    ...
    LABEL = "SM"
    BARCODE_RANGES = {
        LOCATION.CIT: [("32110020008401", "32110020011100"), ("32110020014001", "32110020015000")],
        LOCATION.MIB: [("32110020000001", "32110020002800"), ("32110020011101", "32110020012000")],
        LOCATION.PKU: [("32110020002801", "32110020005600"), ("32110020012001", "32110020013000")],
        LOCATION.UVA: [("32110020005601", "32110020008400"), ("32110020013001", "32110020014000")],
    }
...
class DM:
    ...
    LABEL = "DM"
    BARCODE_RANGES = {
        LOCATION.CIT: [("32110040004201", "32110040005600"), ("32110040007001", "32110040007500")],
        LOCATION.MIB: [("32110040000001", "32110040001400"), ("32110040005501", "32110040006000")],
        LOCATION.PKU: [("32110040001401", "32110040002800"), ("32110040006001", "32110040006500")],
        LOCATION.UVA: [("32110040002801", "32110040004200"), ("32110040006501", "32110040007000")],
    }
